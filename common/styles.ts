...
export const colors = (global.secretDarkThemeDoNotUseOrYouWillBeFired) ? Object.assign(normalColors, darkColors) : normalColors; // tslint:disable-line
...
const styles = {...normalStyles, colors, dark: false};
